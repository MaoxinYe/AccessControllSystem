...
$(function(){
    ...
    jQuery.validator.addMethod("isPwd", function(value, element) { 
    	//alert(/^[a-zA-Z]\\w{6,16}$/.test(value));
         return this.optional(element) || /^[a-zA-Z]\w{5,16}$/.test(value);       
	...
	//含中文的最大长度
	jQuery.validator.addMethod("maxLengthInCN", function(value, element, param) {
		var length = value.length;
	...
	jQuery.validator.addMethod("checkXlsx", function(value, element) {
	...
	jQuery.validator.addMethod("checkXls", function(value, element) {
		var fileArr=value.split("\\");
		var fileTArr=fileArr[fileArr.length-1].toLowerCase().split(".");
		var filetype=fileTArr[fileTArr.length-1];
		if(filetype != "xls"){
