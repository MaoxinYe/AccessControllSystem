...
<article class="page-container">
	<form action="system-menubar-add" method="post" class="form form-horizontal" id="form-system-menubar-add">
		<div class="tabBar cl">
			<span>添加菜单信息</span>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入6位数字" id="modulecode" name="modulecode" style="width:200px">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入菜单名称" id="modulename" name="modulename" style="width:200px">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>页面路径：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入页面路径" id="modulepage" name="modulepage" style="width:200px">
			</div>
		</div>		
		<div class="row cl">
...
$(function(){	
	$("#form-system-menubar-add").validate({
		debug:true,
		rules:{
			supercode:{ required:true, },
			modulecode:{ required:true, number:true, rangelength: [6,6], min:100000, remote: "check-modulecode.html" },
			modulename:{ required:true, maxlength: 10,remote: "check-modulename.html" },
			modulepage:{ required:true, maxlength: 50,remote: "check-modulepage.html" },
		},
		messages: {
			...
			modulepage:{ required: "请输入菜单对应页面", maxlength: "最多输入50个字符",remote: "页面路径已被使用" },
		},
		onkeyup:false,
		focusCleanup:false,
		success:"valid",
		submitHandler:function(form){
			$(form).ajaxSubmit({
					...
					success: function(data){
						if(data.head){
							layer.msg("功能菜单添加成功!",{icon:1,time:1000},function(){
