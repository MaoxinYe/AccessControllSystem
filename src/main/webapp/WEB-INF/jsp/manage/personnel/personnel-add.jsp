...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-personnel-add" enctype="multipart/form-data" >
		<div class="tabBar cl">
			<span>添加人员</span>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" style="width: 200px" placeholder="" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" style="width: 200px" placeholder="" id="credentials" name="credentials">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>联系电话：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" style="width: 200px" id="tel" name="tel">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl" id="disexpiration" style="display:none;">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="expirationdate" id="expirationdate" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd' })" style="width: 200px" class="input-text Wdate" />
			</div>
		</div>
<!-- 		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">门禁卡编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" style="width: 200px" placeholder="" id="cardid" name="cardid">
			</div>
		</div> -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">详细地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" style="width: 200px" placeholder="" id="address" name="address">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">备注：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" style="width: 200px" placeholder="" id="remarks" name="remarks">
			</div>
		</div>
