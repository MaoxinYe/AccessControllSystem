...
<form name="searchresult" id="searchresult" action="" method="post">
    ...
    <table class="table table-border table-bordered table-hover table-bg ">
		<tbody>
			...
			<tr class="text-c">
				<td style="font-size: 20px">访客姓名：${visitor.name}</td>
				<td style="font-size: 20px">访客证件号：${visitor.credentials}</td>
			</tr>
			<tr class="text-c">
				<td style="font-size: 20px">受访人员姓名：${personnel.name}</td>
				<td style="font-size: 20px">受访人员证件号：${personnel.credentials}</td>
			</tr>
			<tr class="text-c">
			...
			<tr>
				<td>访客模板照：
              		<img id="img1" src="${session_photoVirtualPath}${visitor.path}" width="171px" height="210px" alt="无照片"/>
           		</td>
           		<td>访客现场照：
